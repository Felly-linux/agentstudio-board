...
function EmptyState({ message }) {
  return /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-dashed border-gray-700 bg-gray-950 p-8 font-mono flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-600", children: message }) });
}
function LoadingState({ rows = 3 }) {
  return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono space-y-3", children: [
    /* @__PURE__ */ jsx("div", { className: "h-3 bg-gray-800 rounded animate-pulse w-1/3" }),
    Array.from({ length: rows }).map((_, i) => /* @__PURE__ */ jsx("div", { className: "h-8 bg-gray-800 rounded animate-pulse" }, i))
  ] });
}
...
function IncidentDashboard({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: `rounded-lg border ${colors.border} ${isResolved ? "bg-gray-950 opacity-75" : colors.bg} p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-3 mb-4 flex-wrap", children: [
      ...
      incident.status && /* @__PURE__ */ jsx2("span", { className: `px-2 py-0.5 rounded text-xs font-medium ${statusBadge[incident.status]}`, children: incident.status }),
      /* @__PURE__ */ jsx2("span", { className: `text-sm font-semibold ${colors.text} flex-1`, children: incident.title }),
      /* @__PURE__ */ jsx2("span", { className: "text-xs text-gray-500", children: isResolved && incident.resolvedAt ? `resolved ${elapsed(incident.resolvedAt)}` : elapsed(incident.startedAt) })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-500 mb-1", children: "Servicios afectados" }),
    ...
    incident.timeline && incident.timeline.length > 0 && /* @__PURE__ */ jsxs2("div", { className: "mb-4", children: [
      ...
      /* @__PURE__ */ jsx2("div", { className: "space-y-1.5 border-l border-gray-800 pl-3", children: incident.timeline.map((e, i) => /* @__PURE__ */ jsxs2("div", { className: "flex gap-3 text-xs relative", children: [
        /* @__PURE__ */ jsx2("div", { className: "w-1.5 h-1.5 rounded-full bg-gray-700 absolute -left-4 top-1" }),
        /* @__PURE__ */ jsx2("span", { className: "text-gray-600 shrink-0", children: new Date(e.at).toLocaleTimeString() }),
        /* @__PURE__ */ jsx2("span", { className: "text-gray-300", children: e.event })
      ] }, i)) })
    ] }),
...
function ServiceHealth({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ jsxs3("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx3("h3", { className: "text-sm font-semibold text-gray-300", children: "Service Health" }),
        unhealthyCount > 0 && /* @__PURE__ */ jsxs3("span", { className: "text-xs text-red-400 font-semibold", children: [
          unhealthyCount,
          " degraded"
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: sorted.map((s) => {
      ...
      return /* @__PURE__ */ jsxs3("div", { className: `flex items-center gap-3 rounded px-3 py-2 border ${cfg.border} bg-gray-900`, children: [
        /* @__PURE__ */ jsx3("div", { className: `w-2 h-2 rounded-full ${cfg.dot} shrink-0` }),
        /* @__PURE__ */ jsx3("span", { className: "text-xs text-gray-300 w-28 shrink-0", children: s.name }),
        /* @__PURE__ */ jsx3("span", { className: `text-xs ${cfg.text} w-16 shrink-0`, children: s.status }),
        /* @__PURE__ */ jsxs3("span", { className: "text-xs text-gray-500", children: [
          "p99: ",
          s.latencyP99,
          "ms"
        ] }),
        /* @__PURE__ */ jsxs3("span", { className: `text-xs w-20 text-right ${s.errorRate > 1 ? "text-red-400" : "text-gray-600"}`, children: [
          "err: ",
          s.errorRate,
          "%"
        ] }),
        /* @__PURE__ */ jsxs3("span", { className: "text-xs text-gray-700 w-16 text-right", children: [
          s.rps,
          " rps"
        ] }),
        s.uptimePct != null && /* @__PURE__ */ jsxs3("span", { className: `text-xs w-16 text-right ${s.uptimePct < 99 ? "text-yellow-500" : "text-gray-700"}`, children: [
          s.uptimePct,
          "%"
        ] }),
...
function SprintBoard({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs4("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ jsxs4("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsx4("h3", { className: "text-sm font-semibold text-gray-300", children: sprintName }),
      /* @__PURE__ */ jsxs4("div", { className: "flex gap-4 text-xs", children: [
        /* @__PURE__ */ jsxs4("span", { className: "text-red-400", children: [
          blocked,
          " blocked"
        ] }),
        /* @__PURE__ */ jsxs4("span", { className: "text-green-400", children: [
          done,
          " done"
        ] }),
    ...
    /* @__PURE__ */ jsx4("div", { className: "space-y-2", children: tasks.map((t) => {
      ...
      return /* @__PURE__ */ jsxs4("div", { className: `rounded border ${cfg.border} ${cfg.bg} px-3 py-2`, children: [
        /* @__PURE__ */ jsxs4("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx4("span", { className: "text-xs text-gray-600", children: t.id }),
          /* @__PURE__ */ jsx4("span", { className: "text-xs text-gray-200 flex-1", children: t.title }),
          /* @__PURE__ */ jsx4("span", { className: `text-xs ${cfg.text}`, children: cfg.label }),
          /* @__PURE__ */ jsx4("span", { className: "text-xs text-gray-600", children: t.assignee }),
        ...
        t.blocker && /* @__PURE__ */ jsxs4("p", { className: "text-xs text-red-300 mt-1 ml-8", children: [
          "\u26A1 ",
          t.blocker
        ] })
      ] }, t.id);
...
function MetricsChart({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs5("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    ...
    /* @__PURE__ */ jsx5(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxs5(LineChart, { data: points, children: [
      ...
      /* @__PURE__ */ jsx5(YAxis, { tick: { fontSize: 9, fill: "#6b7280" } }),
      /* @__PURE__ */ jsx5(
        Tooltip,
        {
      ...
      threshold != null && /* @__PURE__ */ jsx5(ReferenceLine, { y: threshold, stroke: "#f59e0b", strokeDasharray: "3 3" }),
      /* @__PURE__ */ jsx5(
        Line,
        {
          type: "monotone",
...
function DeployHistory({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
      ...
      return /* @__PURE__ */ jsxs6(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx6("span", { className: "text-xs text-gray-500", children: elapsed2(d.deployedAt) }),
...
function AlertFeed({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    ...
    /* @__PURE__ */ jsx7("div", { className: "space-y-2", children: alerts.map((a) => {
      ...
      return /* @__PURE__ */ jsxs7(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx7("div", { className: `w-2 h-2 rounded-full ${cfg.dot} shrink-0 mt-1` }),
            /* @__PURE__ */ jsxs7("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsx7("p", { className: "text-xs text-gray-300 mt-0.5", children: a.message })
            ] }),
            /* @__PURE__ */ jsx7("span", { className: "text-xs text-gray-600 shrink-0 mt-0.5", children: elapsed3(a.firedAt) })
          ]
        },
        a.id
      );
...
function PersonRow({
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-3 rounded px-3 py-2.5 border border-gray-800 bg-gray-900", children: [
    /* @__PURE__ */ jsx8("div", { className: "w-2 h-2 rounded-full bg-green-400 shrink-0" }),
...
function OnCallStatus({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ jsxs8("div", { className: "flex items-center justify-between mb-4", children: [
      ...
      escalationPolicy && /* @__PURE__ */ jsx8("span", { className: "text-xs text-gray-700", children: escalationPolicy })
    ] }),
