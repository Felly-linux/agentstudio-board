...
function IncidentDashboard({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: `rounded-lg border ${colors.border} ${colors.bg} p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-3 mb-4", children: [
      ...
      /* @__PURE__ */ jsx2("span", { className: `text-sm font-semibold ${colors.text}`, children: incident.title }),
      /* @__PURE__ */ jsx2("span", { className: "ml-auto text-xs text-gray-500", children: elapsed(incident.startedAt) })
    ] }),
    ...
    incident.timeline && /* @__PURE__ */ jsxs2("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsx2("p", { className: "text-xs text-gray-500 mb-2", children: "Timeline" }),
      /* @__PURE__ */ jsx2("div", { className: "space-y-1.5", children: incident.timeline.map((e, i) => /* @__PURE__ */ jsxs2("div", { className: "flex gap-3 text-xs", children: [
    ...
    /* @__PURE__ */ jsxs2("div", { className: "flex gap-2 mt-4", children: [
      /* @__PURE__ */ jsx2(
        "button",
        {
...
function ServiceHealth({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    ...
    /* @__PURE__ */ jsx3("div", { className: "space-y-2", children: services.map((s) => {
      ...
      return /* @__PURE__ */ jsxs3("div", { className: `flex items-center gap-3 rounded px-3 py-2 border ${cfg.border} bg-gray-900`, children: [
        ...
        /* @__PURE__ */ jsx3("span", { className: `text-xs ${cfg.text} w-16`, children: s.status }),
        /* @__PURE__ */ jsxs3("span", { className: "text-xs text-gray-500 ml-auto", children: [
          "p99: ",
          s.latencyP99,
          "ms"
        ] }),
        ...
        /* @__PURE__ */ jsxs3("span", { className: "text-xs text-gray-700 w-20 text-right", children: [
          s.rps,
          " rps"
        ] }),
...
function DeployHistory({ data, onAction, className }) {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: `rounded-lg border border-gray-800 bg-gray-950 p-5 font-mono${className ? ` ${className}` : ""}`, children: [
    ...
    /* @__PURE__ */ jsx6("div", { className: "space-y-2", children: deploys.map((d, i) => {
      ...
      return /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-3 rounded px-3 py-2 border border-gray-800 bg-gray-900 flex-wrap", children: [
        ...
        d.commitSha && /* @__PURE__ */ jsx6("span", { className: "text-xs text-gray-700 bg-gray-800 px-1.5 rounded font-mono", children: d.commitSha }),
        /* @__PURE__ */ jsx6("div", { className: "ml-auto", children: /* @__PURE__ */ jsxs6(
          "button",
          {
